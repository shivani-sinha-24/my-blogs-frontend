...
function App() {
  ...
  useEffect(()=>{
    if(token){
      // get user data
      axios.post(`https://my-blogs-backend-eo37vi84j-shivani-sinha-24.vercel.app/user/get-user`,{token})
      .then(res=>{
    ...
    // get blogs
    axios.get(`https://my-blogs-backend-eo37vi84j-shivani-sinha-24.vercel.app/blog`)
    .then((res) => {
      setBlogs(res.data)
